const Footer = () => (
  <footer id="footer" className="bg-void border-t border-sb py-10 px-6 md:py-12 md:px-16 flex flex-col md:flex-row items-center md:justify-between text-center md:text-left gap-5 md:flex-nowrap">
    {/* Left */}
    <div>
