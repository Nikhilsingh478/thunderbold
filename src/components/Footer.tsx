    ...
    <>
      <footer className="bg-void border-t border-white/[0.07] pt-10 md:pt-16 pb-0 px-6 md:px-16">
        <div className="max-w-[1200px] mx-auto">
          ...
          {/* Bottom bar */}
          <div className="border-t border-white/10 pt-6 pb-14 sm:pb-10 flex flex-col sm:flex-row items-center justify-between gap-3">
            <span className="font-display text-[0.68rem] tracking-[0.14em] uppercase text-zinc-300 font-medium text-center sm:text-left">
              Copyright © 2026 ThunderBold Private Limited. All rights reserved.
            </span>
            <span className="font-display text-[0.65rem] tracking-[0.14em] uppercase text-zinc-400 font-medium">
